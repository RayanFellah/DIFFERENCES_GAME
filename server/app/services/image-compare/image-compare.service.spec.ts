...
describe('ImageCompareService', () => {
    ...
    describe('compareImages', () => {
        ...
        it('should return the correct number of differences', async () => {
            ...
            jest.spyOn(service as unknown, 'createDifferenceDetector').mockReturnValue(mockDifferenceDetector);
        ...
        it('should return the correct imageBase64 value', async () => {
            ...
            jest.spyOn(service as unknown, 'createJimpImage').mockReturnValue(mockImage);
        ...
        it('should return an error message if an error occurs', async () => {
            jest.spyOn(service as unknown, 'createDifferenceDetector').mockImplementation(() => {
