...
describe('GameLogicController', () => {
  ...
  describe('finishGame', () => {
    ...
    it('should not update sheet if bestScore is less than or equal to current topScore', async () => {
      const sheet: Sheet = { title: 'game2' , _id: '2', topScore: 5, difficulty: '', originalImagePath: '', modifiedImagePath:'', radius:0 , differences:2 , isJoinable: true, topPlayer : 'skander' };
